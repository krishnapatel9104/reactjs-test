        ...
        return (
          <Box key={index}>
            ...
            >
              ...
              >
                <Box>
                  <img src={order.imageSource} alt="imageicon" height="65px" width="55px" />
                </Box>
                <Box
                  sx={{
                    opacity: "0.8",
                ...
                <Box sx={{ marginTop: "20px" }}>
                  ...
                  >
                    {sizeList.map((s, index) => (
                      <MenuItem key={index} value={s} sx={{ padding: "10px 10px" }}>
                        {s}
                      </MenuItem>
                    ))}
                  </Select>
                ...
                <Box sx={{ marginTop: "20px" }}>
                  ...
                  >
                    {colourList.map((color, index) => (
                      <MenuItem key={index} value={color} sx={{ padding: "10px 10px" }}>
                        {color}
                      </MenuItem>
                    ))}
                  </Select>
